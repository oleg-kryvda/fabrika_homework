...
Вывести порядковый номер последнего числа в массиве, большего K. Если таких чисел нет, то вывести 0.
*/
...
public class homework44
{
	...
	{		
		...
		if (numb>0)	{
			System.out.print("Last number greater than " + K + " in the array at number: " + (numb));
		}
		else 	{
